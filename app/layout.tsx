  ...
  return (
    <html lang="en">
      <body className={inter.className}>
        <header className="sticky top-0 w-screen px-4 lg:px-6 py-2.5">
          <nav className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
            ...
            <div className="flex items-center">
              ...
              {/* TODO open resume */}
              <button className="border border-white rounded-full hover:bg-white hover:text-black font-medium text-sm px-4 lg:px-5 py-1 lg:py-1.5 my-1 lg:my-1.5 mx-1">
                Resume
              </button>
            </div>
          </nav>
        ...
        {children}
        <footer className="sticky bottom-4 w-screen px-4 lg:px-6 py-2.5">
